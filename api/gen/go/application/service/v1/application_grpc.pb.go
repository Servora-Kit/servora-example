...
const (
	ApplicationService_CreateApplication_FullMethodName      = "/application.service.v1.ApplicationService/CreateApplication"
	ApplicationService_GetApplication_FullMethodName         = "/application.service.v1.ApplicationService/GetApplication"
	ApplicationService_ListApplications_FullMethodName       = "/application.service.v1.ApplicationService/ListApplications"
	ApplicationService_UpdateApplication_FullMethodName      = "/application.service.v1.ApplicationService/UpdateApplication"
	ApplicationService_DeleteApplication_FullMethodName      = "/application.service.v1.ApplicationService/DeleteApplication"
	ApplicationService_RegenerateClientSecret_FullMethodName = "/application.service.v1.ApplicationService/RegenerateClientSecret"
)
...
func (c *applicationServiceClient) RegenerateClientSecret(ctx context.Context, in *RegenerateClientSecretRequest, opts ...grpc.CallOption) (*RegenerateClientSecretResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedApplicationServiceServer) RegenerateClientSecret(context.Context, *RegenerateClientSecretRequest) (*RegenerateClientSecretResponse, error) {
...
func _ApplicationService_RegenerateClientSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServiceServer).RegenerateClientSecret(ctx, req.(*RegenerateClientSecretRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApplicationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "application.service.v1.ApplicationService",
	...
	Metadata: "application/service/v1/application.proto",
}
