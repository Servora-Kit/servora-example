...
var File_template_service_v1_template_doc_proto protoreflect.FileDescriptor
...
func init() { file_template_service_v1_template_doc_proto_init() }
func file_template_service_v1_template_doc_proto_init() {
	if File_template_service_v1_template_doc_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_template_service_v1_template_doc_proto_rawDesc), len(file_template_service_v1_template_doc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_template_service_v1_template_doc_proto_goTypes,
		DependencyIndexes: file_template_service_v1_template_doc_proto_depIdxs,
	}.Build()
	File_template_service_v1_template_doc_proto = out.File
	file_template_service_v1_template_doc_proto_goTypes = nil
	file_template_service_v1_template_doc_proto_depIdxs = nil
}
