...
// 	protoc        (unknown)
// source: iam/service/v1/i_auth.proto
...
var File_iam_service_v1_i_auth_proto protoreflect.FileDescriptor
...
var file_iam_service_v1_i_auth_proto_goTypes = []any{
...
func file_iam_service_v1_i_auth_proto_init() {
	if File_iam_service_v1_i_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_iam_service_v1_i_auth_proto_rawDesc), len(file_iam_service_v1_i_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_iam_service_v1_i_auth_proto_goTypes,
		DependencyIndexes: file_iam_service_v1_i_auth_proto_depIdxs,
	}.Build()
	File_iam_service_v1_i_auth_proto = out.File
	file_iam_service_v1_i_auth_proto_goTypes = nil
	file_iam_service_v1_i_auth_proto_depIdxs = nil
}
