# Spec: audit-service-scaffold

## Purpose

Defines requirements for the `audit-service-scaffold` capability — the directory structure, Go module integration, Buf workspace integration, and Wire DI conventions for the `app/audit/service` microservice.
