# Spec: audit-kafka-consumer

## Purpose

Defines requirements for the `audit-kafka-consumer` capability — how the audit service subscribes to the Kafka audit topic, deserializes and validates incoming events, and manages its lifecycle within the Kratos application.
