# Spec: audit-query-api

## Purpose

Defines requirements for the `audit-query-api` capability — the protobuf-defined query service for reading persisted audit events from ClickHouse, including filtering, cursor-based pagination, and HTTP transcoding.
