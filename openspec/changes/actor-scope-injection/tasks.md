...
- [ ] **T5: 改造 resolveObject 支持 scope vs resource**
...
- [ ] **T6: 迁移 4 个 scope-based 端点的 proto 注解**
  - 文件：
...
- [ ] **T7: 适配 protoc-gen-servora-authz 插件**
...
- [ ] **T8: 实现 requireOrgScope 并在 scope-based service 方法中使用**
