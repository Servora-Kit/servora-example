...
func NewGRPCServer(c *conf.Server, trace *conf.Trace, mtc *telemetry.Metrics, l logger.Logger, auditor audit.Auditor, master *service.MasterService) *kgrpc.Server {
