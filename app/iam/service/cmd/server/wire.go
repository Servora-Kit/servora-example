...
func wireApp(*conf.Server, *conf.Discovery, *conf.Registry, *conf.Data, *conf.App, *conf.Trace, *conf.Metrics, *iamconf.Biz, bootstrap.SvcIdentity, log.Logger) (*kratos.App, func(), error) {
